          ...
          for (var row = 0; row < qrcode.getModuleCount(); row++) {
            for (var col = 0; col < qrcode.getModuleCount(); col++) {
              if (qrcode.isDark(row, col)) {
                ...
                let posy = Math.round(row * tileH) - this.node.getComponent(cc.UITransform).height / 2 + h / 2; //   ctx.lineWidth = ;
...
//# sourceMappingURL=ca8a435700fcb34ee95f6c7ff6da69836f0f9af5.js.map