          ...
          for (var row = 0; row < qrcode.getModuleCount(); row++) {
            for (var col = 0; col < qrcode.getModuleCount(); col++) {
              if (qrcode.isDark(row, col)) {
                ...
                var posx = Math.round(col * tileW) - this.node.getComponent(cc.UITransform).width / 2;
                var posy = Math.round(col * tileH) - this.node.getComponent(cc.UITransform).height / 2;
...
//# sourceMappingURL=a6dcbf150bfda94e3d43346c1c7fd78b4d5d65f4.js.map