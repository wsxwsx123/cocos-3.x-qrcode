          ...
          for (var row = 0; row < qrcode.getModuleCount(); row++) {
            for (var col = 0; col < qrcode.getModuleCount(); col++) {
              if (qrcode.isDark(row, col)) {
                ...
                node.setPosition(cc.v3(Math.round(col * tileW) - this.node.getComponent(cc.UITransform).width / 2 + w, Math.round(row * tileH) - this.node.getComponent(cc.UITransform).height / 2 + h));
...
//# sourceMappingURL=55dfb34ae40c75fe0612eea388312545bb7f55a3.js.map