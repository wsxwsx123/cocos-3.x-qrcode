System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, QRErrorCorrectLevel, QRRSBlock, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f8dd6aS2LFEgr124yA9pqV9", "QRRSBlock", undefined);

      _export("default", QRRSBlock = class QRRSBlock {
        ...
        static getRsBlockTable(typeNumber, errorCorrectLevel) {
          switch (errorCorrectLevel) {
            case (_crd && QRErrorCorrectLevel === void 0 ? (_reportPossibleCrUseOfQRErrorCorrectLevel({
              error: Error()
            ...
            case (_crd && QRErrorCorrectLevel === void 0 ? (_reportPossibleCrUseOfQRErrorCorrectLevel({
              error: Error()
            }), QRErrorCorrectLevel) : QRErrorCorrectLevel).M:
              return this.RS_BLOCK_TABLE[(typeNumber - 1) * 4 + 1];

            case (_crd && QRErrorCorrectLevel === void 0 ? (_reportPossibleCrUseOfQRErrorCorrectLevel({
              error: Error()
            }), QRErrorCorrectLevel) : QRErrorCorrectLevel).Q:
...
//# sourceMappingURL=7a6fa7c72ad2995a1718f3f5ad1cb4ed26ca6e76.js.map