          ...
          for (var row = 0; row < qrcode.getModuleCount(); row++) {
            for (var col = 0; col < qrcode.getModuleCount(); col++) {
              if (qrcode.isDark(row, col)) {
                ...
                var posx = Math.round(col * tileW) - this.node.getComponent(cc.UITransform).width + w / 2;
                var posy = Math.round(col * tileH) - this.node.getComponent(cc.UITransform).height + h / 2;
...
//# sourceMappingURL=873257fd6bfa2fc4fbb1d39b3651574a2cf5242e.js.map