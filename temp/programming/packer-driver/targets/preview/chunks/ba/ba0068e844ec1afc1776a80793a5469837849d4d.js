          ...
          for (var row = 0; row < qrcode.getModuleCount(); row++) {
            for (var col = 0; col < qrcode.getModuleCount(); col++) {
              if (qrcode.isDark(row, col)) {
                ...
                var posy = Math.round(col * tileW) - this.node.getComponent(cc.UITransform).height + h / 2;
                ctx.fillRect(posx, posy, w * 10, h * 10); //   ctx.fillRect();
...
//# sourceMappingURL=ba0068e844ec1afc1776a80793a5469837849d4d.js.map