          ...
          for (var row = 0; row < qrcode.getModuleCount(); row++) {
            for (var col = 0; col < qrcode.getModuleCount(); col++) {
              if (qrcode.isDark(row, col)) {
                ...
                node.setPosition(cc.v3(Math.round(col * tileW) - this.node.getComponent(cc.UITransform).width / 2, Math.round(row * tileH) - this.node.getComponent(cc.UITransform).height / 2));
...
//# sourceMappingURL=923dc101bdb6eb4b7a1313d17e80e81a8611ff28.js.map