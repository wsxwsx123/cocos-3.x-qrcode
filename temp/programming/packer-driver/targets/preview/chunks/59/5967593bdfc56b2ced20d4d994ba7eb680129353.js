          ...
          for (var row = 0; row < qrcode.getModuleCount(); row++) {
            for (var col = 0; col < qrcode.getModuleCount(); col++) {
              if (qrcode.isDark(row, col)) {
                ...
                var posy = Math.round(row * tileH) - this.node.getComponent(cc.UITransform).height / 2 + h / 2; //   ctx.lineWidth = ;
...
//# sourceMappingURL=5967593bdfc56b2ced20d4d994ba7eb680129353.js.map