System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, QRCode, QRErrorCorrectLevel, _cc, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, cc, ccclass, property, test;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("test", test = (_dec = ccclass("test"), _dec2 = property(cc.Node), _dec3 = property(cc.Node), _dec4 = property(cc.Node), _dec(_class = (_class2 = class test extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "ctxNode", _descriptor, this);

          _initializerDefineProperty(this, "btn_Node", _descriptor2, this);

          _initializerDefineProperty(this, "ed_Node", _descriptor3, this);
        ...
        writable: true,
        initializer: null
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "btn_Node", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "ed_Node", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=f49b45781e15afe8f3502d8015f5aeecdf0226eb.js.map